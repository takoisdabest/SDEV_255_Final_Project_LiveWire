    ...
    <div>
      ...
      <section className="about-us">
        ...
        <p>
          ...
          to give students the experience they need, industry connections with reputable companies, and faculty to guide you on 
          your own journey.
        </p>
        <ul>
          ...
          <li>Strong industry partnerships for your future job.</li>
        </ul>
        <p>
